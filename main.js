...
url = ""
let sliderTimeout; //holds the timeout function in it, so it can be cleared
...
$(".filter").on("change", function (e) { // Takes a hashtag input.
  ...
  $("body").on("change", ".slider", function (e) {
    ...
    /* wrap the logic in a timeout, that is cleared at the beginning of every call to this
    function so that the user only sees the action take place once */
